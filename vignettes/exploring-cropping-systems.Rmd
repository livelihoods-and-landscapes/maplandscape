...
Head to a live version of maplandscape <a href="https://livelihoods-and-landscapes.shinyapps.io/demo/" target="_blank">here</a>. Or, if you're familiar with docker you can build and run it locally.
...
Select the <em>Add Column</em> tool. Then select the layer that we want to add a new column too - <em>kava_fields_village</em>. Click the <em>Add Column Options</em> button.
